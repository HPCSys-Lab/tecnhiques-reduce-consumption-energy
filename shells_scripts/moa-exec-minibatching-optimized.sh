...
function Y {
  ...
  if [[ $2 == *"MAX"* ]]; then
    ...
    # batch -> 5
    echo "$RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/${IDENT}-${onlyname}-${2##*.}-25-4-5-1"
    java -Xshare:off -XX:+UseParallelGC -Xmx$Memory -cp $MOA_HOME/lib/:$MOA_HOME/lib/moa.jar moa.DoTask "EvaluateInterleavedTestThenTrainChunksOptimized -l ($2 -s 25 -c 3) -s (ArffFileStream -f $1) -t 120 -c 5 -e (BasicClassificationPerformanceEvaluator -o -p -r -f) -i -1 -d $RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/dump-${onlyname}-${2##*.}-25-4-5-1" > ${RESULT_DIR}/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/term-${IDENT}-${onlyname}-${2##*.}-25-4-5-1
    
    # batch -> 15
    echo "$RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/${IDENT}-${onlyname}-${2##*.}-25-4-15-1"
    java -Xshare:off -XX:+UseParallelGC -Xmx$Memory -cp $MOA_HOME/lib/:$MOA_HOME/lib/moa.jar moa.DoTask "EvaluateInterleavedTestThenTrainChunksOptimized -l ($2 -s 25 -c 3) -s (ArffFileStream -f $1) -t 120 -c 15 -e (BasicClassificationPerformanceEvaluator -o -p -r -f) -i -1 -d $RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/dump-${onlyname}-${2##*.}-25-4-15-1" > ${RESULT_DIR}/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/term-${IDENT}-${onlyname}-${2##*.}-25-4-15-1

    # batch -> 25
    echo "$RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/${IDENT}-${onlyname}-${2##*.}-25-4-25-1"
    java -Xshare:off -XX:+UseParallelGC -Xmx$Memory -cp $MOA_HOME/lib/:$MOA_HOME/lib/moa.jar moa.DoTask "EvaluateInterleavedTestThenTrainChunksOptimized -l ($2 -s 25 -c 3) -s (ArffFileStream -f $1) -t 120 -c 25 -e (BasicClassificationPerformanceEvaluator -o -p -r -f) -i -1 -d $RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/dump-${onlyname}-${2##*.}-25-4-25-1" > ${RESULT_DIR}/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/term-${IDENT}-${onlyname}-${2##*.}-25-4-25-1

    # batch -> 50
    echo "$RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/${IDENT}-${onlyname}-${2##*.}-25-4-50-1"
    java -Xshare:off -XX:+UseParallelGC -Xmx$Memory -cp $MOA_HOME/lib/:$MOA_HOME/lib/moa.jar moa.DoTask "EvaluateInterleavedTestThenTrainChunksOptimized -l ($2 -s 25 -c 3) -s (ArffFileStream -f $1) -t 120 -c 50 -e (BasicClassificationPerformanceEvaluator -o -p -r -f) -i -1 -d $RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/dump-${onlyname}-${2##*.}-25-4-50-1" > ${RESULT_DIR}/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/term-${IDENT}-${onlyname}-${2##*.}-25-4-50-1

    # batch -> 75
    echo "$RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/${IDENT}-${onlyname}-${2##*.}-25-4-75-1"
    java -Xshare:off -XX:+UseParallelGC -Xmx$Memory -cp $MOA_HOME/lib/:$MOA_HOME/lib/moa.jar moa.DoTask "EvaluateInterleavedTestThenTrainChunksOptimized -l ($2 -s 25 -c 3) -s (ArffFileStream -f $1) -t 120 -c 75 -e (BasicClassificationPerformanceEvaluator -o -p -r -f) -i -1 -d $RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/dump-${onlyname}-${2##*.}-25-4-75-1" > ${RESULT_DIR}/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/term-${IDENT}-${onlyname}-${2##*.}-25-4-75-1

    # batch -> 100
    echo "$RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/${IDENT}-${onlyname}-${2##*.}-25-4-100-1"
    java -Xshare:off -XX:+UseParallelGC -Xmx$Memory -cp $MOA_HOME/lib/:$MOA_HOME/lib/moa.jar moa.DoTask "EvaluateInterleavedTestThenTrainChunksOptimized -l ($2 -s 25 -c 3) -s (ArffFileStream -f $1) -t 120 -c 100 -e (BasicClassificationPerformanceEvaluator -o -p -r -f) -i -1 -d $RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/dump-${onlyname}-${2##*.}-25-4-100-1" > ${RESULT_DIR}/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/term-${IDENT}-${onlyname}-${2##*.}-25-4-100-1


    # batch -> 250
    echo "$RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/${IDENT}-${onlyname}-${2##*.}-25-4-250-1"
    java -Xshare:off -XX:+UseParallelGC -Xmx$Memory -cp $MOA_HOME/lib/:$MOA_HOME/lib/moa.jar moa.DoTask "EvaluateInterleavedTestThenTrainChunksOptimized -l ($2 -s 25 -c 3) -s (ArffFileStream -f $1) -t 120 -c 250 -e (BasicClassificationPerformanceEvaluator -o -p -r -f) -i -1 -d $RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/dump-${onlyname}-${2##*.}-25-4-250-1" > ${RESULT_DIR}/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/term-${IDENT}-${onlyname}-${2##*.}-25-4-250-1

    # batch -> 500
    echo "$RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/${IDENT}-${onlyname}-${2##*.}-25-4-500-1"
    java -Xshare:off -XX:+UseParallelGC -Xmx$Memory -cp $MOA_HOME/lib/:$MOA_HOME/lib/moa.jar moa.DoTask "EvaluateInterleavedTestThenTrainChunksOptimized -l ($2 -s 25 -c 3) -s (ArffFileStream -f $1) -t 120 -c 500 -e (BasicClassificationPerformanceEvaluator -o -p -r -f) -i -1 -d $RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/dump-${onlyname}-${2##*.}-25-4-500-1" > ${RESULT_DIR}/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/term-${IDENT}-${onlyname}-${2##*.}-25-4-500-1

    # batch -> 2000
    echo "$RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/${IDENT}-${onlyname}-${2##*.}-25-4-2000-1"
    java -Xshare:off -XX:+UseParallelGC -Xmx$Memory -cp $MOA_HOME/lib/:$MOA_HOME/lib/moa.jar moa.DoTask "EvaluateInterleavedTestThenTrainChunksOptimized -l ($2 -s 25 -c 3) -s (ArffFileStream -f $1) -t 120 -c 2000 -e (BasicClassificationPerformanceEvaluator -o -p -r -f) -i -1 -d $RESULT_DIR/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/dump-${onlyname}-${2##*.}-25-4-2000-1" > ${RESULT_DIR}/$FREQUENCIA_MINIMA/$FREQUENCIA_MAXIMA/$3/term-${IDENT}-${onlyname}-${2##*.}-25-4-2000-1
  elif [[ ${2} == *"RUNPER"* ]]; then
    IDENT="interleaved"
