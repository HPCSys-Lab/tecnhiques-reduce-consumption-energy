...
#declare -a algs=("meta.LBagMC" "meta.OzaBagAdwinMC" "meta.OzaBagMC" "meta.AdaptiveRandomForestMC")
declare -a algs=("meta.AdaptiveRandomForest")
declare -a ensemble_size=(100 150)
declare -a cores=(1 2 3 4 5 6 7)
mkdir /opt/data/Executor-results-ARF
export RESULT_DIR=/opt/data/Executor-results-ARF
